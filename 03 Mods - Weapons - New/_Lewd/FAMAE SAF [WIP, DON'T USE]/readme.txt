...
The mod's "LEWD FAD CAMO" that only adds a spray paint tool is not touched by any of these files.

----------------------------------------------------------
-Patches:

No camo variants
Self explanatory. Only the basic variant will be added to the game.
