...
Its support for Weapon Cover Tilt is fixed. It monkey patches things properly instead of inefectually replacing the original script with a DLTX method, or worse, breaking WCT itself depending of the load order.
Thanks to MRdemonized and Vodoxleb for the tips.
