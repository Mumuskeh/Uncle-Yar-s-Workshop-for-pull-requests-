...
Armor Modkits addon
The mod includes upgraded versions of the rifle, but this requires a Special Upgrade Pack only available in Gamma (that I know). With this patch you'll be able to use a specialized modkit instead.
