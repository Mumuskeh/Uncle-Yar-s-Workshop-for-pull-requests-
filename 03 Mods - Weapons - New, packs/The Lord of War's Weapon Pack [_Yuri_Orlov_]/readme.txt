...
You don't need the original mod. This module is completely standalone.

----------------------------------------------------------
-Explanation:

Weapons cut down to the shortened MP-133 and MP-153, both in configs and icons.

The rest of guns and ammo are already available from other mods, more widely used and/or in better maintenance state.
